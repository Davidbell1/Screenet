...
export const GENERAL_WOMEN = {
	...
	category: 'general',
	order: 0,
	text: '<p>Women of all ages should practice breast awareness and engage in regular <a href="https://www.bcna.org.au/breast-health-awareness/breast-awareness/" target="_bank">self examination</a>.</p><br/><p>The following additional screening tests or consultations are recommended for you:</p><ul>'
};
export const GENERAL_WOMEN_END = {
	id: 'GENERAL_WOMEN_END',
	category: 'general',
	order: 0,
